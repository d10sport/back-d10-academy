export const htmlTemplateRegisterClub = (name) => {
  return `
    <!DOCTYPE html>
      <html lang="es">
        <head>
          ...
          <div class="email-approve">
            ...
            <div class="content__email-approve">
              ...
              <p class="text__email-approve">
                ...
                correctamente. Ahora debes esperar que el administrador complete la solicitud y
                seras BIENVENIDO a nuestro sitio web. Una vez esto se
